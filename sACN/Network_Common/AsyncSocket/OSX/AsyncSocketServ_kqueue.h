// AsyncSocketServ_kqueue.h: interface for the CAsyncSocketServ class.
//
//This class implements the OSX-Specific IAsyncSocketServ implementation
//of socket support that uses blocking sockets, with a thread that uses kevent
...
#error "#include error: AsyncSocketServ_kqueue.h requires AsyncSocketInterface.h"
#endif
#ifndef _OSX_ASYNCSOCKETINTERFACE_H_
#error "#include error: AsyncSocketServ_kqueue.h requires OSXAsyncSocketInterface.h"
#endif
#ifndef _SUBSCRIPTIONS_H_
#error "#include error: AsyncSocketServ_kqueue.h requires Subscriptions.h"
#endif
#ifndef _READER_WRITER_H_
#error "#include error: AsyncSocketServ_kqueue.h requires ReaderWriter.h"
#endif
#ifndef _MEMPOOL_H_
#error "#include error: AsyncSocketServ_kqueue.h requires MemPool.h"
#endif
#ifndef _IFACESUPPORT_H_
#error "#include error: AsyncSocketServ_kqueue.h requires IfaceSupport.h"
#endif
...
private:
	...
	struct socketref
	{
      ...
      CSubscriptions sublist;  //While subscriptions are actually handled/tracked by the special subscription list, 
								 //we need to know what this socket thinks it subscribed to.  This member is NOT used to limit the subscription count.
	 ...
	 */
	int SubscribeSocketAddSubscription(const CIPAddr& maddr, bool& dosocksubscribe);
	int SubscribeSocketRemoveSubscription(const CIPAddr& maddr);
	...
	void SocketStopAutoRecv(socketref* pref);
