...
bool  CIPAddr::IsLinkLocalAddress() const
{
	//A v4 address has it's upper 2 bytes at 169.254
	//A v6 address has the upper 10 bits being 1111 1110 10
	bool v4 = IsV4Address();
	return (v4 && (m_addr[12] == 169) && (m_addr[13] == 254)) ||
		   (!v4 && (m_addr[0] == 0xfe) && (0x80 == (m_addr[1] & 0xc0)));
}
